...
A = eye(N);                          % feedback matrix, i.e. eye(N), magic(N), hadamard(N) or randn(N)
...
lowpass_mode = 'butter'; % Lowpass filter mode. No filtering: 'none', lowpass: 'lowpass', butterworth: 'butter', moving average: 'MA'
