...
N = 8;                               % number of interconnected delay lines
...
g_gains = zeros(1,N); % power(g_lin, m_delays);       % g_gains calculated by given equation

y = FDN_func(wav, fs, A, b_gains, c_gains, g_gains, m_delays);
impulse_response = FDN_func(unitimpulse, fs, A, b_gains, c_gains, g_gains, m_delays);
